...
class PowerMonitor:
    ...
    # Removed monitoring_loop and threading logic for single-threaded polling


    def start_monitoring(self):
        """Initialize sensor for polling (no thread)"""
    ...
    def stop_monitoring(self):
        """No-op for compatibility (no thread to stop)"""
        self.save_csv_log()
        logging.info("Power monitoring stopped (no thread)")
